...
def check_password():
    ...
    if crack_secs < 1:
        ...
        crack_time = f"{int(crack_secs)} seconds"
    elif crack_secs < 3600:
        crack_time = f"{int(crack_secs/60)} minutes"
    elif crack_secs < 86400:
        crack_time = f"{int(crack_secs/3600)} hours"
    elif crack_secs < 31536000:
        crack_time = f"{int(crack_secs/86400)} days"
    elif crack_secs < 3153600000:
        crack_time = f"{int(crack_secs/31536000)} years"
    else:

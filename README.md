...
CyberShield is a web-based cybersecurity platform designed to detect malicious URLs, phishing attacks, and suspicious domains in real time.
The system analyzes user-submitted links using automated threat detection techniques and provides a security risk score indicating whether the link is safe or dangerous.
...
https://cybershield-arathi-0dms.onrender.com
...
![CyberShield Flow](cybershield_system_flow.jpg)
...
If you would like to improve CyberShield, feel free to fork the repository and submit a pull request.
...
**Arathi S M**
Cybersecurity Enthusiast | AI & Security Learner
